...
export function createSystemApiClient(baseUrl: string, fetchImplementation?: typeof fetch) { return hc<SystemApiType>(baseUrl, createApiClientOptions(fetchImplementation)); }
